/**
 * cppvsdbg/libs/eigen/eigenUtils.ts — Eigen helpers for vsdbg (cppvsdbg) sessions.
 *
 * Uses (long long) casts matching MSVC expression syntax.
 * Expressionally identical to gdb/libs/eigen/eigenUtils.ts.
 */
